    ...
    namespace proyecto_final__respaldo_
{
    public class Biblioteca
    {
        public class Material
        {
            ...
            {
                return $"Identificador: {Identificador}, Título: {Titulo}, Cantidad Registrada: {Cantidad_registrada}, Cantidad Actual: {Cantidad_actual}, Fecha Registro: {Fecharegistro.ToShortDateString()}";
            }
        }
